//
//  TodayTableViewModelTests.swift
//  NBCTests
//
...
class TodayTableViewModelTests: XCTestCase {
    func testMakeSection_formatsCorrectlyDatesAndPrices() {
        ...
        zip(currencies, expectedPriceOutput).forEach { (currency: Currency, priceOutput: String) in
            ...
            let historicalViewModel = TodayTableViewModel.makeSectionViewModel(from: [valuation], title: inputTitle)
